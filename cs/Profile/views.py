...
from Profile.models import Profile, Ciudad, Estado, EstadoCivil, Genero, Ocupacion
from Profile.serializer import ProfileSerializers, CiudadSerializers, EstadoSerializers, EstadoCivilSerializers, GeneroSerializers, OcupacionSerializers
